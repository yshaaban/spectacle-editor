...
class Spinner extends Component {
  componentDidMount() {
      ...
      actors.actor_4={node:document.getElementById("SVG-Circus-a475b338-504e-f312-5218-91b9bc643dc8").getElementById("actor_4"),type:"circle",cx:30,cy:50,dx:8,dy:33,opacity:0.5};
      ...
      actors.actor_6={node:document.getElementById("SVG-Circus-a475b338-504e-f312-5218-91b9bc643dc8").getElementById("actor_6"),type:"circle",cx:30,cy:50,dx:7,dy:33,opacity:0.25};
      var tricks={};
      ...
      var scenarios={};
      scenarios.scenario_1={actors: ["actor_1","actor_2","actor_3","actor_4","actor_5","actor_6"],tricks: [{trick: "trick_1",start:0,end:1.00},{trick: "trick_2",start:0,end:1}],startAfter:0,duration:9000,actorDelay:250,repeat:0,repeatDelay:0};
  ...
  render() {
    return (
      ...
      >
        <circle id="actor_6" cx="30" cy="50" r="3.5" opacity="0.25"
